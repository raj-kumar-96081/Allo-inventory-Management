...
-- CreateEnum
CREATE TYPE "LedgerEventType" AS ENUM ('STOCK_IN', 'STOCK_OUT', 'RESERVED', 'RELEASED', 'CONFIRMED', 'ADJUSTMENT');
...
-- CreateIndex
CREATE INDEX "InventoryLedger_inventoryId_idx" ON "InventoryLedger"("inventoryId");
